<footer className="py-20 bg-orange-10">
            <div className="container mx-auto px-4">
                <div className="pb-6 sm:flex justify-between content-center lg:pb-10 border-b border-gray-100">
                    <div className="md:flex flex-wrap items-start justify-between">
                        <div className="w-full lg:w-auto text-white">
                            <p className='text-white'>Kristen Harper</p>
                            <p className='text-white'>903-780-9969</p>
                            <a className="hover:text-gray-50" href="/contact">Contact</a>
                        </div>
                    </div>
                        <a className='flex content-center' href='https://www.bbb.org/us/tx/tyler/profile/dog-breeders/texas-top-notch-frenchies-1075-28112964/#sealclick'><img className="h-20 place-self-center rounded-lg p-0" src='https://seal-easttexas.bbb.org/seals/black-seal-187-130-bbb-28112964.png' alt="" /></a>
                </div>
                <div>
                    <div className="md:flex flex-wrap justify-between items-center">
                        <p className="text-sm text-white mt-8">All rights reserved © Texas Top Notch Frenchies 2022</p>
                        <div className="flex order-first sm:order-last mt-8">
                            <a className="flex justify-center items-center w-10 h-10 mr-4 bg-gray-50 rounded-full" href="https://www.facebook.com/texastopnotchfrenchies">
                            ...
                            <a className="flex justify-center items-center w-10 h-10 mr-4 bg-gray-50 rounded-full" href="#">
